...
6. Issue detail pages show the engineering plan sections when a plan exists.
7. Issue detail pages handle missing plans without breaking.
8. Triage groups incidents by operational state and shows domain owner plus postmortem requirement.
9. Postmortems show impact, root cause, resolution, and prevention.
10. The interface stays calm and ownership-centered across desktop and mobile widths.
